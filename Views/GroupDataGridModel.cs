...
public class GroupDataGridModel : ObservableCollection<GroupDataGridView>
{
    ...
    public string GetBoxGroupName(string groupId_)=> this.ToList().Find((d) => (d.GroupId == groupId_))?.GroupName ?? string.Empty;
    ...
    public string GetBoxGroupId(string groupName_)=> this.ToList().Find((d) => (d.GroupName == groupName_))?.GroupId ?? string.Empty;
