...
public partial class WaitWindow : Window
{
    ...
    public void MessageClear(string message_ ="")=>App.Current.Dispatcher.Invoke(() => {this._textBox.Text = message_; });

    /// <summary>
    /// 表示メッセージ追加
    /// </summary>
    /// <param name="message_"></param>
    public void MessageAdd(string message_)=> App.Current.Dispatcher.Invoke(() => { this._textBox.Text += message_; this._textBox.ScrollToEnd(); });
